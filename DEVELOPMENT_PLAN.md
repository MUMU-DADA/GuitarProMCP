...
当前窗口恢复核心在 Windows PowerShell 5.1 与 PowerShell 7 下分别完整通过十六组、2574 项回归，其中包含 281 项标签与原生菜单检查，另通过原生保存故障恢复 167 项。另存修复的 2486 项、标签重排的 2469 项及后台 DDE/连接 61 项、可见 DDE/连接 60 项仍作为历史基线保留。路径、二进制哈希和启动等待条件见下方记录及 [覆盖清单](COVERAGE.md#当前验证证据)。
