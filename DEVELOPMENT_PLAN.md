...
3. P3 已按必要范围完成，下一阶段为 P4 选区与剪贴板。P7 扩展资源不足、模板初始化异常、恢复期间外部改动、复杂曲谱和更广泛模态组合，不把这些组合的未穷举结果表述为已验证。
...
6. 按顺序完成 P4、P5、P6，每个阶段验收后提交，再在最终发布包上执行 P7。按实际受影响阶段报告阻塞，安装只是完整项目的一部分。
