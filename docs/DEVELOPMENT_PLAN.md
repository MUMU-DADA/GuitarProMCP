...
更新日期：2026-09-08。本文件记录 P0-P7 阶段计划、验收标准和执行历史，并集中记录当前 P8 的实施计划。当前协作规范、开发目标、产品要求、范围决策和质量门槛统一见 [AGENTS.md](../AGENTS.md)；P8 的实施细节和验收拆分维护在本文件。

> 维护规则：P8 实施细节、子阶段和计划验收更新本文件；当前能力状态和最新实证更新 `AGENTS.md`、`COVERAGE.md` 或 `native/README.md`。未实现的计划内容不得写入已验证能力。
