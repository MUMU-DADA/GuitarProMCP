...
P2 当前构建十四组回归共 2225 项通过，退出码为 0，连接描述已清理：`artifacts/regression-dd6830958c334f7cb5ad42add6e4bd4d/regression.json`。其中新增保存专项 30 项，证据为 `artifacts/native-saving-b5e392dce3c84e17b2812cc960cd84c3/verification.json`。该轮包含独立文档 UUID 和已退出进程身份识别修复；保存中途失败恢复仍未计入通过范围。
