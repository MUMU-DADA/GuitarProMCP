...
if ($CheckLaunchForwarding -and -not (Test-Path -LiteralPath $ddeClient)) { throw 'Build test/build-dde-client.ps1 before testing the registered file-association protocol.' }
