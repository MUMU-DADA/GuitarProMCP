...
try {
    ...
    $sources=@('guitarpro_io.h','guitarpro_mcp.cpp','guitarpro_abi.h','host_build.h','test-p6.ps1','test-exchange.ps1','supported-host.json') | ForEach-Object {Get-FileHash (Join-Path $PSScriptRoot $_) | Select-Object Path,Hash}
