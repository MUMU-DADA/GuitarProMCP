...
$suites = @('mcp','native','editing','tracks','measures','effects','selection','saving','document-operations','document-tabs','lifecycle','session','structure','clipboard','tuplets','connections','notation','instruments','score-form','transfer','audio','p6','p8','p9','p10')
$results = @()
$fixtureRestorations = @()
$complete = $false
